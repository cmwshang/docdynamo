####################################################################################################################################
# HostGroup.pm - Encapsulate a group of docker containers for testing
####################################################################################################################################
package docDynamo::Common::Process::HostGroup;
...
sub hostGroupGet
{
    ...
    {
        $oHostGroup = new docDynamo::Common::Process::HostGroup();
    }
