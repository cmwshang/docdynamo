...
use constant HTML_TABLE_DATA                                        => 'td';
    push @EXPORT, qw(HTML_TABLE_DATA);
use constant HTML_TABLE_HEADER                                      => 'th';
    push @EXPORT, qw(HTML_TABLE_HEADER);
use constant HTML_TABLE_ROW                                         => 'tr';
    push @EXPORT, qw(HTML_TABLE_ROW);
