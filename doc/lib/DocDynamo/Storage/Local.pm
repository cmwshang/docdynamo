...
####################################################################################################################################
package docDynamo::Storage::Local;
use parent 'docDynamo::Storage::Base';
...
use docDynamo::Storage::Filter::Sha;
...
sub new
{
    ...
    # {
    #     require docDynamo::Storage::Filter::CipherBlock;
    #     docDynamo::Storage::Filter::CipherBlock->import();
    # }
...
sub hashSize
{
    ...
    {
        $lSize = 0;
        my $oShaIo = new docDynamo::Storage::Filter::Sha($oFileIo);
        my $lSizeRead;
