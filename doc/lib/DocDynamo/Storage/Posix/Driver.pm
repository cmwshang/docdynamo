...
####################################################################################################################################
package docDynamo::Storage::Posix::Driver;
...
use docDynamo::Storage::Base;
use docDynamo::Storage::Posix::FileRead;
use docDynamo::Storage::Posix::FileWrite;
...
sub openRead
{
    ...
    my $oFileIO = new docDynamo::Storage::Posix::FileRead($self, $strFile, {bIgnoreMissing => $bIgnoreMissing});
...
sub openWrite
{
    ...
    my $oFileIO = new docDynamo::Storage::Posix::FileWrite(
        $self, $strFile,
